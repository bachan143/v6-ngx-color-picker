...
import { EventEmitter, Directive, Output, Input, Injectable, Component, ViewChild, ReflectiveInjector, NgModule } from '@angular/core';
...
export { ColorPickerComponent, ColorPickerDirective, ColorPickerModule, ColorPickerService, Hsla, Hsva, Rgba, SliderDirective, TextDirective };
